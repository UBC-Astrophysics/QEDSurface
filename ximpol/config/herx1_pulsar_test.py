...
pdegree_data=2*numpy.array([0,0.032765,0.0490032,0.065200,0.070770,0.086773,0.1025,0.116778,0.130228,0.142785,0.154202,0.164246,0.172673,0.180627,0.187338,0.192776,0.196445,0.198123,0.198696])
print (len(pdegree_ang),len(pdegree_data))
pdegree_funk=numpy.vectorize(scipy.interpolate.interp1d(pdegree_ang,pdegree_data,kind='cubic'))
