...
# rad, inclination, energy, phot_flux, ratio = numpy.loadtxt(_full_path("15qedoff.txt"),usecols=range(5),
#unpack=True)

dtype=[('incl',float),('ener',float),('flux',float),('ratio',float)]
arr=numpy.loadtxt(_full_path("15qedoff.txt"),usecols=(1,2,3,4),dtype=dtype)
