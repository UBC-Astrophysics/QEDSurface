...
from ximpol.config.four_u_pulsar import pol_degree_spline, \
...
"""
CFG_FILE_PATH = os.path.join(XIMPOL_CONFIG, 'four_u_pulsar.py')
OUT_FILE_PATH_BASE = os.path.join(XIMPOL_DATA, '4u_pulsar')
